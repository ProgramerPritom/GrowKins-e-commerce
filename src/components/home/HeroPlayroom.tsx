...
export const HeroPlayroom: React.FC = () => {
  ...
  return (
    <section 
      ...
      className="relative overflow-hidden bg-gradient-to-b from-[#FCF4DB]/80 via-[#FAF7F1] to-[#FAF7F1] pt-10 pb-16 md:pt-16 md:pb-24 border-b border-[#E8E0D2]/60"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-6 space-y-6 text-left">
            ...
            {/* Headline */}
            <h1 className="font-serif text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tight text-[#24221F] leading-[1.08]">
            ...
            <p className="text-lg sm:text-xl text-[#6E6A63] max-w-lg leading-relaxed font-normal">
              {t.hero.subheading}
            </p>
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2">
              <button
                ...
                className="px-8 py-4 rounded-full bg-[#24221F] text-[#FAF7F1] text-sm font-semibold hover:bg-[#1C4CB8] transition-all duration-200 shadow-md hover:shadow-lg flex items-center gap-2 active:scale-95 group cursor-pointer"
              >
              ...
              <button
                ...
                className="px-8 py-4 rounded-full bg-[#FFFFFF] border border-[#D9D3C7] text-[#24221F] text-sm font-semibold hover:bg-[#F4EFE6] transition-all duration-200 shadow-xs active:scale-95 cursor-pointer"
              >
                {t.hero.exploreAll}
              </button>
            </div>
            ...
            <div className="pt-4 flex items-center gap-6 text-xs text-[#757169] border-t border-[#E8E0D2]/60 max-w-md">
              <span className="flex items-center gap-1.5 font-medium">
                <Truck className="w-4 h-4 text-[#4F7A5E]" />
                {t.hero.codNotice}
              </span>
              <span className="flex items-center gap-1.5 font-medium">
                <ShieldCheck className="w-4 h-4 text-[#A67E14]" />
                {t.hero.woodNotice}
              </span>
            </div>
          ...
          <div className="lg:col-span-6 relative">
            <div className="relative mx-auto max-w-lg lg:max-w-none">
              ...
              >
                ...
                <div className="absolute top-1/2 -translate-y-1/2 left-3 right-3 flex items-center justify-between opacity-0 group-hover:opacity-100 transition-opacity duration-200 z-10 pointer-events-auto">
                  <button
                    onClick={handlePrevSlide}
                    className="w-9 h-9 rounded-full bg-white/90 backdrop-blur-sm text-[#24221F] hover:bg-white shadow-md flex items-center justify-center cursor-pointer active:scale-95 transition-all"
              ...
              <div 
                ...
                className="absolute -top-6 -left-6 sm:-top-8 sm:-left-8 w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-[#1C4CB8] text-white shadow-xl flex items-center justify-center transition-transform duration-300 ease-out hover:rotate-12 cursor-pointer z-20"
              ...
              <div 
                ...
                onClick={() => setView('shop')}
                className="absolute -bottom-6 -right-4 sm:-bottom-8 sm:-right-6 bg-white rounded-2xl p-4 shadow-xl border border-[#E8E0D2] flex items-center gap-3 cursor-pointer hover:shadow-2xl transition-all duration-200 z-20"
              >
                <div className="w-12 h-12 rounded-xl overflow-hidden bg-[#FCF4DB]">
                  <img
                ...
                <div className="text-left pr-2">
                  <div className="text-xs font-semibold text-[#24221F]">Sunrise Arch</div>
                  <div className="text-[11px] text-[#A67E14] font-medium">Bestseller · ৳1,950</div>
                </div>
                <div className="w-7 h-7 rounded-full bg-[#FAF7F1] flex items-center justify-center text-[#24221F]">
